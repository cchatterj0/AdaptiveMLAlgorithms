...
% Chanchal Chatterjee
% December 2021
% AL1 - Comparison of Adaptive EVD Homogeneous, Deflated, Weighted
...
for epoch = 1 : nEpochs
   for iter = 1 : nSamples
      ...
      W1 = W1 + etat1*(A*W1 - W1*(W1'*A*W1) - mu*W1*(W1'*W1-I));
      
      % Deflated Gradient Descent
      W2 = W2 + etat1*(A*W2 - W2*triu(W2'*A*W2) - mu*W2*triu(W2'*W2-I));
      
      % Weighted Gradient Descent
      W3 = W3 + etat2*(A*W3*C - W3*C*(W3'*A*W3) - mu*W3*C*(W3'*W3-I));
