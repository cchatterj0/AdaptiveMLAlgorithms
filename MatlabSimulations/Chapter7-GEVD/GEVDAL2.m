...
% Chanchal Chatterjee
% December 2021
% AL2 - Comparison of Adaptive GEVD Homogeneous, Deflated, Weighted
...
for epoch = 1 : nEpochs
    for iter = 1 : nSamples
        ...
        %W1 = W1 + etat*(A*W1 - B*W1*(W1'*A*W1));
      
        % Deflated Gradient Descent
        W2 = W2 + etat1*(A*W2 - 0.5*B*W2*triu(W2'*A*W2) - 0.5*A*W2*triu(W2'*B*W2) - mu*B*W2*triu(W2'*B*W2 - Ip));
      
        % Weighted Gradient Descent
        W3 = W3 + etat2*(A*W3*C - B*W3*C*(W3'*A*W3) - A*W3*C*(W3'*B*W3) - mu*B*W3*C*(W3'*B*W3 - Ip));
