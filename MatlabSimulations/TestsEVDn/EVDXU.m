...
for epoch = 1 : nEpochs
   for iter = 1 : nSamples
      ...
      W1 = W1 + etat1*(A*W1 - 0.5*W1*(W1'*A*W1) - 0.5*A*W1*(W1'*W1));
      
      % Deflated Gradient Descent
      W2 = W2 + etat1*(A*W2 - 0.5*W2*triu(W2'*A*W2) - 0.5*A*W2*triu(W2'*W2));
      
      % Weighted Gradient Descent
      W3 = W3 + etat2*(A*W3*C - 0.5*W3*C*(W3'*A*W3) - 0.5*A*W3*C*(W3'*W3));
